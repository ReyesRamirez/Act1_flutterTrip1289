  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: PageView(
        ...
        children: <Widget>[
          makePage(
            image: 'https://raw.githubusercontent.com/ReyesRamirez/Act1_FlutterTrip/main/nigiri.jpg',
            title: "Sushi Nigiri",
            description:'El Nigiri es la expresión más pura y elegante del sushi. Cada pieza consiste en una pequeña porción de arroz de sushi, moldeada a mano a la perfección, coronada con una loncha impecable de pescado o marisco fresco de la más alta calidad. Una experiencia minimalista pero profundamente satisfactoria que resalta la frescura del ingrediente principal.',
            pageNumber: 1,
          ),
          makePage(
            image: 'https://raw.githubusercontent.com/ReyesRamirez/Act1_FlutterTrip/main/arcoiris.png',
            title: "Sushi Arcoiris",
            description:'El Arcoíris es una obra de arte culinaria que deleita tanto a la vista como al paladar. Sobre un roll de sushi relleno de cangrejo y aguacate, se despliega una vibrante selección de finas lonchas de pescado fresco, como atún, salmón y pez blanco. Cada pieza ofrece una sinfonía de texturas y sabores que te transportarán.',
            pageNumber: 2,
            
          ),
          makePage(
            image: 'https://raw.githubusercontent.com/ReyesRamirez/Act1_FlutterTrip/main/roll.jpg',
            title: "Sushi Rolls",
            description:'Nuestros Sushi Rolls son una explosión de sabor en cada bocado. Delicadas láminas de alga nori abrazan arroz de sushi perfectamente sazonado, rellenos de ingredientes frescos como pescado, mariscos, vegetales crujientes y cremosos aderezos. Ideales para compartir o para disfrutar de una comida completa y deliciosa. ¡Hay uno para cada gusto!',
            pageNumber: 3,
          ),
          makePage(
            image: 'https://raw.githubusercontent.com/ReyesRamirez/Act1_FlutterTrip/main/empanizado.jpg',
            title: "Sushi Empanizado",
            description:'Para los amantes de lo crujiente, nuestro sushi Empanizado es la elección perfecta. Estos rolls se rebozan ligeramente y se fríen hasta obtener una capa dorada y crocante que contrasta maravillosamente con el suave relleno interior. Experimenta una nueva dimensión de sabor y textura con cada mordisco.',
            pageNumber: 4,
          ),
        ],
      ),
